...
public class ProjectMapper {
    ...
    public ProjectResource toResource(Project model) {return mapper.map(model, ProjectResource.class);}
    ...
    public Project toModel(UpdateProjectResource resource) {return mapper.map(resource, Project.class);}
}
